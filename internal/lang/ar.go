...
var arabic = Catalogue{
	...
	EnrolPrivateBody: "هذه المحادثة — أنا وأنت فقط — هي ذاكرتك الخاصة. ما تقوله لي هنا يبقى في مساحتك. " +
		"لا يستطيع أحد آخر في المنزل قراءته، ولن أذكره في المحادثة الجماعية.",
