...
var spanish = Catalogue{
	...
	SavePromises: []string{
		...
		"lo guardaré", "lo apuntaré", "lo anotaré", "no lo olvido",
	},

	SaveRequests: []string{
		"recuerda", "recuérda", "acuérdate", "acuerdate", "que recuerdes",
		"apunta", "apúnta", "anota", "anóta", "guarda", "guárda",
		"toma nota", "tomar nota", "no olvides", "no te olvides",
		"que no se te olvide", "no lo olvides", "escribe esto", "escribe eso",
		"registra", "memoriza", "quédate con", "para la próxima",
	},
	...
	EnrolPrivateBody: "Este chat —solo tú y yo— es tu memoria privada. Lo que me cuentes aquí se guarda en tu propio " +
		"espacio, y el grupo del hogar nunca puede leerlo. Yo tampoco lo sacaré ahí.",
	EnrolPrivateSealed: "Este hogar funciona en modo aislado: tu asistente tiene un proceso propio y una clave propia. " +
