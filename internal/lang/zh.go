...
var chinese = Catalogue{
	...
	EnrolPrivateBody: "这个聊天——只有你和我——就是你的私人记忆。你在这里告诉我的内容，会保存在你自己的空间里，" +
		"家庭群聊永远读不到。我也不会在群里提起。",
	EnrolPrivateSealed: "这个家运行在隔离模式下：你的助手有自己的进程和自己的密钥。家里其他任何人都读不到你的私人记忆，" +
		"运行这台机器的人也读不到。诚实的界限是：拥有这台机器 root 权限的人，在你的助手运行期间可以拿到你的密钥。",
	EnrolSharedOnlyHeading: "我们共用一份记忆",
	EnrolSharedOnlyBody: "你是这个家的一员，所以我在这里和家庭群里都会回应你，你可以问我任何这个家知道的事。" +
		"\n\n你没有的是属于你自己的记忆。这里没有只属于你和我的空间：我从你这里记住的一切" +
		"都会写进这个家的共享记忆，所有人都能读到。所以我会先把原话给你看，你说可以之后我才" +
		"写——在这个对话里和在群里一样，因为两边是同一份记忆。" +
		"\n\n如果你更希望有一份自己的记忆，就去跟给我做设置的人说。改变的时候什么都不会带" +
		"过去，因为从来就没有存过东西。",
	...
	EnrolMemoryBodyDefault: "当某件事听起来值得存进你自己的记忆时，我会记下来，然后原样告诉你我写了什么、存进了哪个记忆，" +
		"并附上一个撤销按钮，按一下就能收回——按下之后，它不会再出现在任何回答里，这里不会，家里的其他设备上也不会。" +
		"凡是要进入家庭共享记忆的内容，我都会先问你，在你点“保存到家庭”之前不会写入任何东西。\n\n" +
